...
if ( ! defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	exit;
		...
		// Leave no trail review-slider-for-woocommerce_version widget_srfw_widget
		$option1 = 'review-slider-for-woocommerce_version';
		$option2 = 'srfw_woo_settings';
		$option3 = 'widget_srfw_widget';
		$option4 = 'srfw_options';
		$option5 = 'srfw_notice_hide_woo';
		$option6 = 'srfw_activated_time_woo';
